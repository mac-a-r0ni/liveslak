...
echo "Loading GRUB for liveslak"
set default=0
set timeout=20
...
if loadfont dejavusansmono19 ; then
  ...
  insmod gettext
  insmod png
  set theme=$cmdpath/liveslak/theme.txt
  export theme
fi
